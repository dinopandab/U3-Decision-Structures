...
//EXTRA NOTES
//DECIMAL FORMAT DOESN'T CHANGE THE DATA BUT RATHER THE WAY ITS DISPLAYED
//manipulation of math with division ny using math.round and multiplying y 100.0
//-to make the rest of the decimals disappear
//null means something that does not exist (never been created)
//Once set layout to null you have to manually place things